...
-- CreateEnum
CREATE TYPE "CryptoDepositStatus" AS ENUM ('PENDING', 'VERIFIED', 'REJECTED', 'COMPLETED');
...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('DEPOSIT', 'WITHDRAWAL', 'TRANSFER_IN', 'TRANSFER_OUT', 'PAYMENT', 'REFUND', 'FEE', 'INTEREST', 'LOAN_DISBURSEMENT', 'LOAN_REPAYMENT', 'CARD_PAYMENT', 'CARD_REFUND', 'CRYPTO_DEPOSIT', 'CRYPTO_WITHDRAWAL', 'INVESTMENT', 'DIVIDEND', 'BONUS', 'CHARGE', 'REVERSAL');
...
-- CreateEnum
CREATE TYPE "ChequeDepositStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "BankDepositStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
...
CREATE TABLE "cheque_deposits" (
    ...
    "accountId" TEXT NOT NULL,
    "amount" DOUBLE PRECISION NOT NULL,
    "chequeImage" TEXT NOT NULL,
    "status" "ChequeDepositStatus" NOT NULL DEFAULT 'PENDING',
    "submittedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "processedAt" TIMESTAMP(3),
    "processedBy" TEXT,
    "adminNotes" TEXT,
    ...
    CONSTRAINT "cheque_deposits_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "bank_deposits" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "userBankAccountId" TEXT NOT NULL,
    "accountId" TEXT NOT NULL,
    "amount" DOUBLE PRECISION NOT NULL,
...
-- CreateIndex
CREATE INDEX "crypto_deposits_tokenId_idx" ON "crypto_deposits"("tokenId");
...
-- CreateIndex
CREATE UNIQUE INDEX "international_transfers_transactionId_key" ON "international_transfers"("transactionId");

-- CreateIndex
CREATE INDEX "international_transfers_userId_status_idx" ON "international_transfers"("userId", "status");

-- CreateIndex
CREATE INDEX "international_transfers_transactionId_idx" ON "international_transfers"("transactionId");
...
-- CreateIndex
CREATE INDEX "cheque_deposits_userId_idx" ON "cheque_deposits"("userId");

-- CreateIndex
CREATE INDEX "cheque_deposits_accountId_idx" ON "cheque_deposits"("accountId");

-- CreateIndex
CREATE INDEX "cheque_deposits_status_idx" ON "cheque_deposits"("status");

-- CreateIndex
CREATE INDEX "user_bank_accounts_userId_idx" ON "user_bank_accounts"("userId");

-- CreateIndex
CREATE INDEX "user_bank_accounts_bankId_idx" ON "user_bank_accounts"("bankId");

-- CreateIndex
CREATE INDEX "user_bank_accounts_isActive_idx" ON "user_bank_accounts"("isActive");

-- CreateIndex
CREATE UNIQUE INDEX "user_bank_accounts_userId_bankId_key" ON "user_bank_accounts"("userId", "bankId");

-- CreateIndex
CREATE INDEX "bank_deposits_userId_idx" ON "bank_deposits"("userId");

-- CreateIndex
CREATE INDEX "bank_deposits_userBankAccountId_idx" ON "bank_deposits"("userBankAccountId");

-- CreateIndex
CREATE INDEX "bank_deposits_accountId_idx" ON "bank_deposits"("accountId");
...
-- AddForeignKey
ALTER TABLE "crypto_deposits" ADD CONSTRAINT "crypto_deposits_tokenId_fkey" FOREIGN KEY ("tokenId") REFERENCES "crypto_tokens"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "cheque_deposits" ADD CONSTRAINT "cheque_deposits_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cheque_deposits" ADD CONSTRAINT "cheque_deposits_processedBy_fkey" FOREIGN KEY ("processedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_bank_accounts" ADD CONSTRAINT "user_bank_accounts_bankId_fkey" FOREIGN KEY ("bankId") REFERENCES "banks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bank_deposits" ADD CONSTRAINT "bank_deposits_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bank_deposits" ADD CONSTRAINT "bank_deposits_userBankAccountId_fkey" FOREIGN KEY ("userBankAccountId") REFERENCES "user_bank_accounts"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bank_deposits" ADD CONSTRAINT "bank_deposits_processedBy_fkey" FOREIGN KEY ("processedBy") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
