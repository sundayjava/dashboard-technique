                  ...
                  {!isCollapsed && (
                    <>
                      ...
                      {item.notificationKey &&
                        unreadCounts[item.notificationKey] > 0 && (
                    ...
                    {item.subMenu!.map((subItem) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {subItem.notificationKey &&
                            unreadCounts[subItem.notificationKey] > 0 && (
          ...
          <div className="absolute bottom-0 left-0 right-0 border-t border-gray-800">
            ...
            {user && !user.isPlusUser && onPlusUpgrade && (
              <div className="p-3 border-b border-gray-800">
                <div
                  className="bg-linear-to-r from-purple-600 via-indigo-600 to-purple-700 rounded-lg p-3 cursor-pointer hover:from-purple-700 hover:via-indigo-700 hover:to-purple-800 transition-all"
                  onClick={onPlusUpgrade}
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] bg-yellow-400 text-purple-900 px-1.5 py-0.5 rounded-full font-bold">
                      NEW
                    </span>
                  </div>
