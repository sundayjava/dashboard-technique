    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="py-16" style={{ background: 'linear-gradient(to right, #10b981, #c1ff72)' }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Latest News</h1>
          <p className="text-gray-800">Stay updated with the latest news and announcements</p>
        </div>
      </div>
